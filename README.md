...
Illumina is a mod that adds new lighting options for your base! With candles, lanterns, and lamps, you now have a much wider variety of choices to light up your home!

**See the wiki for details on the mod!**

-------------------------------------------------

The current version was built with Minecraft 1.12.2 and MinecraftForge v14.23.4.2768.
...
Illumina is licensed under the [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International](https://creativecommons.org/licenses/by-nc-sa/4.0/)
